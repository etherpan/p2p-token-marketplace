  ...
  return (
    <Box p="12px" position="inherit">
      ...
      <FormContainer>
        <Box>
          <Box my="10px">
            <Text fontSize="12px" color="primary">Token or LP Token address*</Text>
            <Input
            ...
            {isAnotherOwner && <><Text fontSize="12px" color="primary">Owner*</Text>
            <Input
              id="token-search-input"
          ...
          <Box mb="20px">
            <Text fontSize="12px" color="primary">Title</Text>
            <Input
              id="token-search-input"
          ...
          <Box mb="20px">
            <Text fontSize="12px" color="primary">Amount*</Text>
            <Input
              id="token-search-input"
              type="number"
          ...
          {!isVesting && <Box mb="20px">
            <Text fontSize="12px" color="primary">Lock until (UTC)*</Text>
            <Input
              type="datetime-local"
          ...
          {isVesting && <Box mb="20px">
            <Flex flexDirection={["column", "column", "column", "row"]}>
              <Box width="100%" mb={["15px", "15px", "15px", "0"]}>
                <Text fontSize="12px" color="primary">TGE Date (UTC)*</Text>
                <Input
                  type="datetime-local"
                  placeholder="Select date"
                  scale="md"
              ...
              <Box ml={["0", "0", "0", "25px"]} mb={["15px", "15px", "15px", "0"]} width="100%">
                <Text fontSize="12px" color="primary">TGE Percent*</Text>
                <Input
                  type="number"
                  placeholder='Ex: 10'
                  scale="md"
          ...
          {isVesting && <Box mb="20px">
            <Flex flexDirection={["column", "column", "column", "row"]}>
              <Box width="100%" mb={["15px", "15px", "15px", "0"]}>
                <Text fontSize="12px" color="primary">Cycle (days)*</Text>
                <Input
                  type="number"
                  placeholder='Ex: 10'
                  scale="md"
              ...
              <Box ml={["0", "0", "0", "25px"]} mb={["15px", "15px", "15px", "0"]} width="100%">
                <Text fontSize="12px" color="primary">Cycle Release Percent*</Text>
                <Input
                  type="number"
                  placeholder='Ex: 10'
                  scale="md"
