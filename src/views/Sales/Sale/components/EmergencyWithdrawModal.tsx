...
const EmergencyWithdrawModal: React.FC<React.PropsWithChildren<DepositModalProps>> = ({
  chainId,
  pool,
  onDismiss,
}) => {
  ...
  const { onEmergencyWithdraw } = usePool(pool, false)
  ...
  const onConfirm = async () => {
    const receipt = await fetchWithCatchTxError(() => onEmergencyWithdraw())
