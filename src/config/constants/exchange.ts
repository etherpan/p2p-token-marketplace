...
export const SUGGESTED_BASES: ChainTokenList = {
  [ChainId.BSC]: [WNATIVE[ChainId.BSC], USDT[ChainId.BSC], USDC[ChainId.BSC], arbitrumTokens.arb, GTOKEN[ChainId.BSC], DAI_ARB, WBTC_ARB],
}

// used to construct intermediary pairs for trading
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  [ChainId.BSC]: [WNATIVE[ChainId.BSC], USDC[ChainId.BSC], USDT[ChainId.BSC], WBTC_ARB],
}

export const BASES_TO_TRACK_LIQUIDITY_FOR: ChainTokenList = {
	[ChainId.BSC]: [USDC[ChainId.BSC], WNATIVE[ChainId.BSC], USDT[ChainId.BSC], WBTC_ARB],
}

export const PINNED_PAIRS: { readonly [chainId in ChainId]?: [Token, Token][] } = {
  [ChainId.BSC]: [
    [WNATIVE[ChainId.BSC], USDC[ChainId.BSC]],
    [WBTC_ARB, WNATIVE[ChainId.BSC]],
